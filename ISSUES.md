...
|----|-------|--------|----------|--------|---------|
| A11W-ISS-13 | Four orphaned Netlify forms (email-capture-hero/inline/modal/footer) remain registered with zero submissions - delete once release-updates is proven | Open | low | — | pending |
